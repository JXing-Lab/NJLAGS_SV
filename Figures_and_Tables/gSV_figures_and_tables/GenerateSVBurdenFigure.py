...
'''
GRAPH + STATS INCLUDING KNOME BATCH (13 affecteds)
'''
...
plt.savefig('/lab01/Projects/Sammy_Projects/NJLAGS_SVs/data/figures/burden_analysis.png')
plt.savefig('/lab01/Projects/Sammy_Projects/NJLAGS_SVs/data/figures/burden_analysis.pdf',format='pdf')
plt.show()
...
with open('/lab01/Projects/Sammy_Projects/NJLAGS_SVs/data/figures/burden_analysis_stats.txt', 'w') as f:
